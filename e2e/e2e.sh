...
echo 1 | RUST_LOG=info cargo run --release  --bin control -- --unsafe-passphrase --keys-path $BASE_DIR/plumo-verifier.keys --upload-mode azure new-round --verify-transcript --expected-participant 0xad0e687cda8fe660895068e72cd2d8117a1601b5 --new-participant 0x3228897a50dc42d65492d5af8f01ca2cf6752637
...
echo 1 | RUST_LOG=info cargo run --release  --bin contribute -- --unsafe-passphrase --exit-when-finished-contributing --keys-path $BASE_DIR/plumo-verifier.keys --participation-mode verify
echo 1 | RUST_LOG=info cargo run --release  --bin control -- --unsafe-passphrase --keys-path $BASE_DIR/plumo-verifier.keys --upload-mode azure new-round --verify-transcript --expected-participant 0x3228897a50dc42d65492d5af8f01ca2cf6752637
