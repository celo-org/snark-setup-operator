...
echo 1 | RUST_LOG=info cargo run --release  --bin control -- --unsafe-passphrase --keys-path $BASE_DIR/plumo-verifier.keys --coordinator-url http://localhost:8080 new-round --verify-transcript --expected-participant 0xc31130dc73f078f99fac28e250535cbc3407608d --new-participant 0x31e598a18069f75983dc00c39aafc7e9f7b71aee --publish
