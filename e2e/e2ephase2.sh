...
echo 1 | RUST_LOG=info cargo run --bin new_ceremony --release -- --phase phase2 --upload-mode direct --chunk-size 1024 --powers 18 --num-epochs 1 --num-validators 1 --phase1-filename phase2_init --server-url http://localhost:8080  --verifier 0xb522a4df212f0baa380d1dd480affbb955b39595 --participant 0xc31130dc73f078f99fac28e250535cbc3407608d --output-dir ./snark-setup-coordinator/coordinator-service/.storage --unsafe-passphrase --keys-file $BASE_DIR/plumo-verifier.keys --deployer 0xb522a4df212f0baa380d1dd480affbb955b39595
