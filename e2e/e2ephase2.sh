...
#echo 1 | RUST_LOG=info cargo run --release  --bin control -- --phase phase2 -i new_challenge.query -I new_challenge.full --unsafe-passphrase --keys-file $BASE_DIR/plumo-verifier.keys --coordinator-url http://localhost:8080 new-round --expected-participant 0xc31130dc73f078f99fac28e250535cbc3407608d --new-participant 0x31e598a18069f75983dc00c39aafc7e9f7b71aee --publish --shutdown-delay-time-in-secs 10
